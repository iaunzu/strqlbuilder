...
public class TypedQueryImpl<X> implements StrTypedQuery<X> {
    ...
    public String getSQL() {
        ...
        SqmTranslation<SelectStatement> sqmTraslation =
                getSqmTraslation(sqm, hqlInterpretation.getDomainParameterXref(), delegate);
        ...
        final SqmTranslation<SelectStatement> sqmInterpretation = session.getFactory()
                .getQueryEngine()
        ...
        final JdbcParameterBindings jdbcParameterBindings = SqmUtil.createJdbcParameterBindings(
                ...
                session);
        JdbcOperationQuerySelect translated =

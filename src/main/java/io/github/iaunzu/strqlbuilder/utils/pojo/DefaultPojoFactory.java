package io.github.iaunzu.strqlbuilder.utils.pojo;
 ...
 *
 * @param <T> Tipo de objeto a instanciar
 */
public class DefaultPojoFactory<T> implements IPojoFactory<T> {
    ...
    public String getValueAsText(Object value) {
        ...
        if (value.getClass().isArray()) {
            ...
            // Este caso se produce cuando intentamos obtener un objeto primitivo (String,
            // Long...)
    ...
    private CustomBooleanEditor getBooleanEditor() {
        if (booleanEditor == null) booleanEditor = new CustomBooleanEditor(true);
